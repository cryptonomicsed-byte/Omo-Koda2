...
- **Changed** (2): ase-vault (not-applicable → deferred/reference, receipt-chain opcode vocabulary), Npc-forge (not-applicable → deferred/reference, Move dNFT mint-event pattern).
